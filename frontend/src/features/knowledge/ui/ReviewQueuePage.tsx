...
import { Loader2, AlertCircle, ChevronDown, ChevronRight, CheckCircle, XCircle } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-xl font-bold text-text-primary tracking-tight">Review Queue</h1>
              ...
              {expandedId === sub.id && (
                <div className="p-4 border-t border-border-subtle bg-base-900/50 space-y-6">
                  <div>
                    ...
                    <div className="p-3 bg-base-800 border border-border rounded-sm text-sm text-text-primary whitespace-pre-wrap">
                      {sub.raw_content}
                    </div>
                  </div>
