  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      <div className="space-y-1">
        <h1 className="text-xl font-bold text-text-primary tracking-tight">Submit Knowledge</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <textarea
            className="w-full h-40 bg-base-800 border border-border rounded-sm p-3 text-sm text-text-primary focus:border-amber focus:ring-1 focus:ring-amber outline-none resize-y"
            value={content}
